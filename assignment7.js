...
var afzal = "hello afzal, would you like to learn some typescript today";
console.log(afzal);
//                                          exercise no 3
// Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
var person_name = "zAid";
...
var quote = 'Quaid e Azam said: "Work Work and Work",';
console.log(quote);
//                                          exercise no 5
// Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message
var message = "Quaid e Azam said: Work Work and Work";
...
var names = ["zaid", "ali", "hussnain", "shaheer", "hamza"];
...
var transportation = ["motorcylcle", "car", "aeroplane", "train"];
var statements = ["it ia easy to move anywhere", "it is comfortable for traveling", "i like it", "i can sleep in train on birth"];
...
var inviting_person = ["hussnain", "ali", "shahrukh"];
...
var places = ["Maka", "madina", "afghanistan", "istanbul", "dubai"];
console.log(places);
...
var guests = ["ali", "ahmad", "usman", "umer", "akber"];
console.log(guests);
//                                          exercise no 20
...
var countries = ["euorpe", "russia", "afghanistan", "america", "pakistan"];
...
if (alien_color == "green") {
    var message = "the player just earned 5 points.";
    console.log(message);
}
// If the alien’s color isn’t green, print a statement that the player just earned 10 points
else {
    var message = "the player just earned 10 points.";
    console.log(message);
}
...
if (alien_color == "green") {
    ...
    var message = "the player just earned 15 points.";
    console.log(message);
}
//                                          exercise no 28 
...
if (age < 2) {
    var message = "the person is baby";
}
// • If the person is at least 2 years old but less than 4, print a message that the person is a toddler.
if (age < 4) {
    var message = "the person is toodler";
    console.log(message);
}
// • If the person is at least 4 years old but less than 13, print a message that the person is a kid.
if (age < 13) {
    var message = "the person is kid";
    console.log(message);
}
// • If the person is at least 13 years old but less than 20, print a message that the person is a teenager.
if (age < 20) {
    var message = "the person is teenager";
    console.log(message);
}
// • If the person is at least 20 years old but less than 65, print a message that the person is an adult.
if (age >= 20 && age < 65) {
    var message = "the person is adult";
    console.log(message);
}
// • If the person is age 65 or older, print a message that the person is an elder.
if (age >= 65) {
    var message = "the person is elder";
    console.log(message);
}
//                                excersice no 29
...
var fruits_array = ["apple", "mango", "bannana", "apricot",];
...
var usernames = ["ali", "zaid", "umer", "admin", "usman"];
...
var current_users = ["ali", "ahmad", "usman", "umer", "abubaker"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
var new_users = ["ali", "ahmad", "ahsan", "naveed", "haider"];
...
var pizza = ["behari kabab", "malai boti", "suppreme"];
...
// "Lahore, Pakistan"
function describe_city1(country, city) {
...
function albums(artist, albumTitle, tracks) {
...
var magicians_names = ["magician1", "magician2", "magician3", "magician4"];
var magicians_names1 = [];
...
make_great(magicians_names);
const new_array = ["magician 1 ", "magician 2", "magician 3", "magician 4"];
show_magicians(new_array);
// //                                      exercise no 44
// Sandwiches: Write a function that accepts a array of items a person wants on a sandwich. The function should have one parameter that collects as many items as the function call provides, and it should print a summary of the sandwich that is being ordered. Call the function three times, using a different number of arguments each time.
var items = ["bread", "chicken", "salt", "sauces", "cheeze", "tomato"];
